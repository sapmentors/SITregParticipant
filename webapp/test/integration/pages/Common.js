sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/sapmentors/sitreg/registration/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.sap.sapmentors.sitreg.registration.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/sapmentors/sitreg/registration/localService/mockserver"], function (mockserver) {
