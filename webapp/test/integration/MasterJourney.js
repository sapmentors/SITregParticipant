sap.ui.define([
		...
		opaTest("MasterList Filtering on MaxParticipants less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("MaxParticipants").
				and.iSelectListItemInViewSettingsDialog("<100 EventDate").
		...
		opaTest("MasterList Filtering on MaxParticipants more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 EventDate").
				and.iPressOKInViewSelectionDialog();
