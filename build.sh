...
wget -nv 'http://central.maven.org/maven2/com/sap/cloud/neo-java-web-sdk/3.99.14/neo-java-web-sdk-3.99.14.zip'
unzip -qq -o neo-java-web-sdk-3.99.14.zip
rm neo-java-web-sdk-3.99.14.zip
