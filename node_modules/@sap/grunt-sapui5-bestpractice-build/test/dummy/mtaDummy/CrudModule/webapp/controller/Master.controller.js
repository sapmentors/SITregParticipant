/*global history */
sap.ui.define([
	"ns/CrudModule/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"ns/CrudModule/model/formatter",
	"sap/m/MessageBox",
	"ns/CrudModule/model/grouper",
	"ns/CrudModule/model/GroupSortState"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("ns.CrudModule.controller.Master", {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("ns.CrudModule.view.ViewSettingsDialog", this);
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							CategoryID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("CategoryID"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				CategoryID: encodeURIComponent(oItem.getBindingContext().getProperty("CategoryID"))
			}, bReplace);
		},
