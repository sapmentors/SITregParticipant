sap.ui.define([
	...
	return BaseController.extend("ns.CrudModule.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Categories", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Categories", oData);
