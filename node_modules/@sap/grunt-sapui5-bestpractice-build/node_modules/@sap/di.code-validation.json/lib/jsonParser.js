...
//                         severity: ProblemSeverity.Warning,
//                         // message: schema.errorMessage || localize('typeArrayMismatchWarning', 'Incorrect type. Expected one of {0}.', schema.type.join(', '))
//                         message: schema.errorMessage || String.format('Incorrect type. Expected one of {0}.', schema.type.join(', '))
//                     });
//                 }
//             }
//             else if (schema.type) {
...
//                         severity: ProblemSeverity.Warning,
//                         // message: schema.errorMessage || localize('typeMismatchWarning', 'Incorrect type. Expected "{0}".', schema.type)
//                         message: schema.errorMessage || String.format('Incorrect type. Expected "{0}".', schema.type)
//                     });
//                 }
//             }
//             if (Array.isArray(schema.allOf)) {
...
//                         code: ErrorCode.EnumValueMismatch,
//                         // message: schema.errorMessage || localize('enumWarning', 'Value is not accepted. Valid values: {0}.', schema.enum.map(function (v) { return JSON.stringify(v); }).join(', '))
//                         message: schema.errorMessage || String.format('Value is not accepted. Valid values: {0}.', schema.enum.map(function (v) { return JSON.stringify(v); }).join(', '))
//                     });
//                 }
//             }
//             if (schema.const) {
...
//                             severity: ProblemSeverity.Warning,
//                             // message: localize('additionalItemsWarning', 'Array has too many items according to schema. Expected {0} or fewer.', subSchemas_1.length)
//                             message: String.format('Array has too many items according to schema. Expected {0} or fewer.', subSchemas_1.length)
//                         });
//                     }
//                 }
//             }
...
//                         //TODO
//                         // message: schema.errorMessage || localize('requiredItemMissingWarning', 'Array does not contain required item.', schema.minItems)
//                         message: schema.errorMessage || String.format('Array does not contain required item. {0}', schema.minItems)
//                     });
//                 }
//             }
//             if (schema.minItems && this.items.length < schema.minItems) {
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('minItemsWarning', 'Array has too few items. Expected {0} or more.', schema.minItems)
//                     message: String.format('Array has too few items. Expected {0} or more.', schema.minItems)
//                 });
//             }
//             if (schema.maxItems && this.items.length > schema.maxItems) {
//                 validationResult.problems.push({
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('maxItemsWarning', 'Array has too many items. Expected {0} or fewer.', schema.minItems)
//                     message: String.format('Array has too many items. Expected {0} or fewer.', schema.minItems)
//                 });
//             }
//             if (schema.uniqueItems === true) {
//                 var values_1 = this.items.map(function (node) {
...
//                         severity: ProblemSeverity.Warning,
//                         // message: localize('multipleOfWarning', 'Value is not divisible by {0}.', schema.multipleOf)
//                         message: String.format('Value is not divisible by {0}.', schema.multipleOf)
//                     });
//                 }
//             }
//             function getExclusiveLimit(limit, exclusive) {
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('exclusiveMinimumWarning', 'Value is below the exclusive minimum of {0}.', exclusiveMinimum)
//                     message: String.format('Value is below the exclusive minimum of {0}.', exclusiveMinimum)
//                 });
//             }
//             var exclusiveMaximum = getExclusiveLimit(schema.maximum, schema.exclusiveMaximum);
//             if (typeof exclusiveMaximum === 'number' && val >= exclusiveMaximum) {
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('exclusiveMaximumWarning', 'Value is above the exclusive maximum of {0}.', exclusiveMaximum)
//                     message: String.format('Value is above the exclusive maximum of {0}.', exclusiveMaximum)
//                 });
//             }
//             var minimum = getLimit(schema.minimum, schema.exclusiveMinimum);
//             if (typeof minimum === 'number' && val < minimum) {
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('minimumWarning', 'Value is below the minimum of {0}.', minimum)
//                     message: String.format('Value is below the minimum of {0}.', minimum)
//                 });
//             }
//             var maximum = getLimit(schema.maximum, schema.exclusiveMaximum);
//             if (typeof maximum === 'number' && val > maximum) {
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('maximumWarning', 'Value is above the maximum of {0}.', maximum)
//                     message: String.format('Value is above the maximum of {0}.', maximum)
//                 });
//             }
//         };
//         return NumberASTNode;
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('minLengthWarning', 'String is shorter than the minimum length of {0}.', schema.minLength)
//                     message: String.format('String is shorter than the minimum length of {0}.', schema.minLength)
//                 });
//             }
//             if (schema.maxLength && this.value.length > schema.maxLength) {
//                 validationResult.problems.push({
...
//                     severity: ProblemSeverity.Warning,
//                     // message: localize('maxLengthWarning', 'String is longer than the maximum length of {0}.', schema.maxLength)
//                     message: String.format('String is longer than the maximum length of {0}.', schema.maxLength)
//                 });
//             }
//             if (schema.pattern) {
//                 var regex = new RegExp(schema.pattern);
...
//                         severity: ProblemSeverity.Warning,
//                         // message: schema.patternErrorMessage || schema.errorMessage || localize('patternWarning', 'String does not match the pattern of "{0}".', schema.pattern)
//                         message: schema.patternErrorMessage || schema.errorMessage || String.format('String does not match the pattern of "{0}".', schema.pattern)
//                     });
//                 }
//             }
//             if (schema.format) {
...
//                                 severity: ProblemSeverity.Warning,
//                                 // message: schema.patternErrorMessage || schema.errorMessage || localize('uriFormatWarning', 'String is not an URI: {0}', errorMessage)
//                                 message: schema.patternErrorMessage || schema.errorMessage || String.format('String is not an URI: {0}', errorMessage)
//                             });
//                         }
//                     }
//                         break;
...
//                             severity: ProblemSeverity.Warning,
//                             // message: localize('MissingRequiredPropWarning', 'Missing property "{0}".', propertyName)
//                             message: String.format('Missing property "{0}".', propertyName)
//                         });
//                     }
//                 });
//             }
...
//                                     severity: ProblemSeverity.Warning,
//                                     // message: schema.errorMessage || localize('DisallowedExtraPropWarning', 'Property {0} is not allowed.', propertyName)
//                                     message: schema.errorMessage || String.format('Property {0} is not allowed.', propertyName)
//                                 });
//                             }
//                             else {
//                                 validationResult.propertiesMatches++;
...
//                         severity: ProblemSeverity.Warning,
//                         // message: localize('MaxPropWarning', 'Object has more properties than limit of {0}.', schema.maxProperties)
//                         message: String.format('Object has more properties than limit of {0}.', schema.maxProperties)
//                     });
//                 }
//             }
//             if (schema.minProperties) {
...
//                         location: { start: this.start, end: this.end },
//                         severity: ProblemSeverity.Warning,
//                         // message: localize('Object has fewer properties than the required number of {0}', schema.minProperties)
//                         message: String.format('Object has fewer properties than the required number of {0}', schema.minProperties)
//                     });
//                 }
//             }
//             if (schema.dependencies) {
...
//                                         severity: ProblemSeverity.Warning,
//                                         // message: localize('RequiredDependentPropWarning', 'Object is missing property {0} required by property {1}.', requiredProp, key)
//                                         message: String.format('Object is missing property {0} required by property {1}.', requiredProp, key)
//                                     });
//                                 }
//                                 else {
//                                     validationResult.propertiesValueMatches++;
...
//                     if (error.code === ErrorCode.EnumValueMismatch) {
//                         // error.message = localize('enumWarning', 'Value is not accepted. Valid values: {0}.', this.enumValues.map(function (v) { return JSON.stringify(v); }).join(', '));
//                         error.message = String.format('Value is not accepted. Valid values: {0}.', this.enumValues.map(function (v) { return JSON.stringify(v); }).join(', '));
//                     }
//                 }
//             }
//         };
...
//                         if (needsComma) {
//                             // _errorAtRange(localize('TrailingComma', 'Trailing comma'), ErrorCode.TrailingComma, { start: commaOffset, end: commaOffset + 1 });
//                             _errorAtRange('Trailing comma', ErrorCode.TrailingComma, { start: commaOffset, end: commaOffset + 1 });
//                         }
//                         continue;
//                     }
//                 }
...
//             if (seen) {
//                 // problems.push({ location: { start: node.key.start, end: node.key.end }, message: localize('DuplicateKeyWarning', "Duplicate object key"), code: ErrorCode.Undefined, severity: ProblemSeverity.Warning });
//                 problems.push({ location: { start: node.key.start, end: node.key.end }, message: "Duplicate object key", code: ErrorCode.Undefined, severity: ProblemSeverity.Warning });
//                 if (seen instanceof PropertyASTNode) {
//                     // problems.push({ location: { start: seen.key.start, end: seen.key.end }, message: localize('DuplicateKeyWarning', "Duplicate object key"), code: ErrorCode.Undefined, severity: ProblemSeverity.Warning });
//                     problems.push({ location: { start: seen.key.start, end: seen.key.end }, message: "Duplicate object key", code: ErrorCode.Undefined, severity: ProblemSeverity.Warning });
//                 }
//                 keysSeen[key.value] = true; // if the same key is duplicate again, avoid duplicate error reporting
//             }
//             else {
