...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        mochaTest: {
            test: {
                options: {
                    ...
                    reporterOptions: {
                        mochaFile: 'tests/xmlValidator/TEST-index.xml'
                    },
                    colors: true,
                    summery: true,
                    captureFile: 'tests/xmlValidator/output.txt', // Optionally capture the reporter output to a file
        ...
        mocha_istanbul: {
            ...
            options: {
                ...
                print: 'summary',
                growlOnSuccess: true,
                excludes: ['lib/**', 'src/fioriAnalysis/rules/**',
                    'src/fioriAnalysis/ui5Utils/**',
                    'src/fioriAnalysis/ui5Versions/**',
                    'src/fioriAnalysis/config/**',
                    'src/lib/**',
                    'test/**', 'node_modules/**'],
                check: {
                    branches: 70,
                ...
                coverageFolder: "coverage/xmlvalidator",
    ...
    grunt.registerTask('xmlValidator-voter', [
        'clean:results',
        'mochaTest',
        'mocha_istanbul'
    ]);
