...
function _shouldIdAttributeBeRequired(validationMetadata, fileResource) {
    ...
    if (fileResource) {
        var sFileResourcePath = fileResource.getPath().toString();
    ...
    if (validationMetadata) {
        _manifestJsonPath = path.join(validationMetadata.getRootPath(), "webapp", "manifest.json");
    }
    if (!fs.existsSync(_manifestJsonPath)) {
        return false;
    }
    // read file
...
module.exports = {
    ...
    setAsFiori: function (fileResource) {
        _isFioriAnalysisRequired = true;
        _isIdAttributeRequired = _shouldIdAttributeBeRequired(undefined, fileResource);
    },
    ...
    generateStableIds: function (fileResources) {
